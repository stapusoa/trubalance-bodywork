  ...
  const filteredAndSortedServices = useMemo(() => {
    ...
    let filtered = services.filter((service) => {
      const matchesDuration =
        durationFilter === 'all' || service.durations.includes(Number(durationFilter))
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-20">
        ...
        <div className="text-center mb-20">
          ...
          <p className="text-xl text-stone-600 max-w-3xl mx-auto leading-relaxed">
            Personalized healing sessions designed to support your unique wellness journey. Each
            service is crafted with intention, compassion, and deep respect for your healing
            process.
          </p>
        </div>
          ...
          <div className="mb-10 sticky top-0 bg-linear-to-br from-gray-50 via-emerald-50/30 to-teal-50/50 z-10 py-4 -mx-4 px-4 sm:-mx-6 sm:px-6 lg:-mx-8 lg:px-8">
            <div className="flex items-center gap-2 overflow-visible pb-2 hide-scrollbar">
              ...
              <DropdownMenu>
                  ...
                  <button className="flex items-center gap-1.5 px-4 py-2 bg-white rounded-full border border-gray-200 hover:border-gray-300 transition-colors whitespace-nowrap text-sm">
                    ...
                    {modalityFilter !== 'all' && (
                      <span className="ml-1 px-2 py-0.5 bg-emerald-100 text-emerald-700 rounded-full text-xs capitalize">
                        {modalityFilter === 'massage'
                          ? 'Massage'
                          : modalityFilter === 'energy'
                            ? 'Energy'
                            : 'Trauma'}
                      </span>
                    )}
                ...
                <DropdownMenuContent align="start" className="w-48">
                  <DropdownMenuRadioGroup
                    ...
                    onValueChange={(value) => setModalityFilter(value as ModalityFilter)}
                  >
              ...
              <DropdownMenu>
                ...
                <DropdownMenuContent align="start" className="w-52">
                  ...
                  >
                    ...
                    <DropdownMenuRadioItem value="duration-short">
                      Duration: Shortest First
                    </DropdownMenuRadioItem>
                    <DropdownMenuRadioItem value="duration-long">
              ...
              <div className="ml-auto text-sm text-gray-600 whitespace-nowrap pl-4">
                ...
                {filteredAndSortedServices.length === 1 ? 'service' : 'services'}
              </div>
            </div>
          </div>
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                {filteredAndSortedServices.map((service, index) => {
                  ...
                  return (
                    <Card
                      key={index}
                      className="group overflow-hidden bg-white/80 backdrop-blur-sm border-0 shadow-lg hover:shadow-2xl transition-all duration-500 hover:scale-105"
                    >
