    ...
    <section id="about" className="relative w-full bg-white py-16 px-4">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <AnimatedSection className="font-inter">
            <h2 className="text-3xl md:text-4xl font-medium mb-6">Where Wellness Meets Luxury</h2>
            <p className="text-lg mb-8">
              At TruBalance Bodywork, we pride ourselves on offering exceptional quality and
              personalized care in every session. Each massage is tailored to your individual needs,
              utilizing techniques such as cupping, aromatherapy, and advanced bodywork—ensuring no
              hidden fees or unexpected costs.
            </p>
            <p className="text-lg mb-8">
              Gratuity is already included, so the price you see is the total price you
              pay—providing you with complete transparency. This allows you to fully relax and focus
              on your healing journey without any concerns.
            </p>
